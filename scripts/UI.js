...
export function Start() {
  ...
  class Range {
    ...
    constructor(text, parent, min, max, step, value, unit, anisotropy) {
      ...
      this.display.textContent = anisotropy
        ? text + (value == 0 ? "disabled" : value + unit)
        : text + value + unit;
    ...
    UpdateAnisotropy() {
      this.display.textContent =
        ...
        (this.element.value == 0
          ? "disabled"
          : Math.pow(2, this.element.value) + this.unit);
      let p =
        MathUtils.inverseLerp(
          this.element.min,
          this.element.max,
  ...
  //#region Controls
  const lookSensitivityIn = new Range(
    "Look sensitivity: ",
    controlsDiv,
    0.1,
    3,
  ...
  const touchControlsIn = new Switch(
    "Touch controls: ",
    controlsDiv,
    touchControls
  );
  ...
  newInputInfo(
    "mousemove",
    "look around (if mouse lock)",
    keyboardMouseInfoDiv
  );
  ...
  newInputInfo(
    false,
    "To enable or disable touch controls, go to Settings - Controls - Touch controls.",
    touchscreenInfoDiv
  );
  newInputInfo(
    false,
    "Use the left side of the screen and the two buttons on the right of the screen to move.",
    touchscreenInfoDiv
  );
  newInputInfo(
    false,
  ...
  newInputInfo(
    false,
    "A project made entierly by one person in about 2 months. Learn more about this project:",
    aboutInfoDiv
  );
  const a = document.createElement("a");
  a.href = "https://github.com/JuanMendezz/ocean-render";
  a.textContent = "https://github.com/JuanMendezz/ocean-render";
